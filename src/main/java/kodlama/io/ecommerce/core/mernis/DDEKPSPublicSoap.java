...
public class DDEKPSPublicSoap {
    ...
    public DDEKPSPublicSoap() {
    }

    public DDEKPSPublicSoap(String url) {
        this.url = url;
    }

    public DDEKPSPublicSoap(String url, int timeOut) {
        this.url = url;
    ...
    protected DDEExtendedSoapSerializationEnvelope createEnvelope() {
        DDEExtendedSoapSerializationEnvelope envelope = new DDEExtendedSoapSerializationEnvelope(DDEExtendedSoapSerializationEnvelope.VER11);
