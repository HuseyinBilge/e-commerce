...
class DDESoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class DDEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DDEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DDEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DDEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DDEDateTimeConverter dateTimeConverter = new DDEStandardDateTimeConverter();

    public DDEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DDEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DDEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DDEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DDEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DDEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
